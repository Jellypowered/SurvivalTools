...
1. PileOfRags.png - Bundle of cleaning rags texture
...
2. Knife.png - Basic utility knife texture
   - Should be ~64x64 pixels
...
3. HandSaw.png - Basic hand saw texture
   - Should be ~64x64 pixels
...
4. BoneSickle.png - Bone-themed sickle texture
   - Should be ~64x64 pixels
...
5. Hoe.png - Farming hoe tool texture
   - Should be ~64x64 pixels
...
6. PryBar.png - Primitive pry bar/lever tool texture
   - Should be ~64x64 pixels
...
7. Abacus.png - Simple counting frame texture
   - Should be ~64x64 pixels
...
=== EXISTING TEXTURES (These will be redone too) ===
16.  Axe.png - Basic forestry axe
17.  Pickaxe.png - Basic mining pickaxe  
18. Hammer.png - Construction hammer
19. Sickle.png - Basic harvesting sickle

20. New Mod Preview for the Workshop/Github Readme.md
